...
class Cli {
    ...
    createVehicle() {
        inquirer
            ...
            else if (answers.vehicleType === 'Mortorbike') {
    ...
    createMotorbike() {
        inquirer
            ...
            .then((answers) => {
            const motorbike = new Motorbike(Cli.generateVin(), answers.color, answers.make, answers.model, parseInt(answers.year), parseInt(answers.weight), parseInt(answers.topSpeed), [new Wheel(parseInt(answers.frontWheelDiameter), answers.frontWheelBrand),
    ...
    performActions() {
        inquirer
            ...
            else if (answers.action === 'Tow Action') {
                for (let i = 0; i < this.vehicles.length; i++) {
                    if (this.vehicles[i].vin === this.selectedVehicleVin) {
